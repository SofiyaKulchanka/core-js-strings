...
function removeFirstOccurrences(str, value) {
  ...
  const indexOfLast = indexOfFirst + length - 1;
  return str.slice(0, indexOfFirst) + str.slice(indexOfLast + 1);
}
...
function invertCase(str) {
  return str
    .split('')
    .map((array) =>
      array === array.toUpperCase() ? array.toLowerCase() : array.toUpperCase()
    )
    .join('');
}
